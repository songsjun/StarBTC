...
async function main() {
    ...
    let orderContractAddress = "0x49D353cBB8304B196281b795be9E9cB9518A9951"//"0xd6c4B6A09C1116E7ce44d8fbFA924d74FE79D2F0";//"0xe391cd92074b5e8af68504f53c104c51da7d5299";
    ...
    let tx = await contract.submitToLenderTransferProof(rawData,utxos,blockHeight,merkleData);
